...
<div class="container mx-auto min-h-screen py-30 px-2 flex flex-col justify-center items-center">
    <div class="w-full max-w-sm lg:max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 flex flex-col items-center">
        ...
        <h5 class="text-2xl text-center font-bold text-yellow-600 mb-2">Donation Unavailable!</h5>
        <p class="text-gray-700 text-center mb-4">We are not ready to receive your donation from here yet. If you have questions, please contact us.</p>
        <a href="{{ route('contact') }}" class="text-blue-700 hover:underline">Go to Contact Page</a>
    </div>
</div>
