        ...
        <div class="w-full max-w-sm lg:max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 flex flex-col items-center">
            <div class="mb-4">
                <svg class="w-16 h-16 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <path stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M15 9l-6 6M9 9l6 6"/>
                </svg>
            </div>
            <h5 class="text-2xl font-bold text-red-600 mb-2">Donation Failed</h5>
            <p class="text-gray-700 text-center mb-4">Unfortunately, your donation could not be processed. Please try again or contact support.</p>
