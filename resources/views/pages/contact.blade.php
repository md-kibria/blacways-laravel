...
@section('content')
    <section class="min-h-screen relative py-15 flex flex-col items-center about-page">
        ...
        <div class="flex flex-col items-center z-20 pt-5 pb-7">
            ...
            <p class="text-gray-500 text-center px-2 md:px-36 lg:px-52 text-md text-capitalized">
                {{ $page->description ?? 'Reach Out To Us Anytime' }}</p>
        </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full lg:w-1/2 px-5 pt-10 lg:pt-0 flex flex-col justify-center space-y-3">
                            ...
                            <div class="flex items-start space-x-4">
                                <div
                                    class="flex items-center justify-center border border-gray-500 rounded-full h-9 w-9 mt-2">
