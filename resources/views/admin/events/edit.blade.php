...
@section('content')
    ...
    <div class="w-full py-22">
        ...
        <form action="{{ route('admin.events.update', $event->id) }}" class="border border-slate-700 w-2/3 mx-auto p-4 px-6 rounded-lg" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <label for="title" class="block font-light my-2 text-slate-100">
                ...
                <input type="title" id="title"
                    ...
                    placeholder="Enter title" value="{{ old('title') ?? $event->title }}" name="title" />
            ...
            <label for="organizer" class="block font-light my-2 text-slate-100">
                ...
                <input type="text" id="organizer"
                    ...
                    placeholder="Enter organizer" value="{{ old('organizer') ?? $event->organizer }}" name="organizer" />
            ...
            <label for="location" class="block font-light my-2 text-slate-100">
                ...
                <input type="text" id="location"
                    ...
                    placeholder="Enter location" value="{{ old('location') ?? $event->location }}" name="location" />
            ...
            <label for="start_time" class="block font-light my-2 text-slate-100">
                ...
                <input type="date" id="start_time"
                    ...
                    placeholder="Enter Start Time" value="{{ old('start_time') ?? \Carbon\Carbon::parse($event->start_time)->format('Y-m-d') }}" name="start_time" />
            ...
            <label for="end_time" class="block font-light my-2 text-slate-100">
                ...
                <input type="date" id="end_time"
                    ...
                    placeholder="Enter End Time" value="{{ old('end_time') ?? \Carbon\Carbon::parse($event->end_time)->format('Y-m-d') }}" name="end_time" />
            ...
            <label for="description" class="block font-light my-2 text-slate-100">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="mt-0.5 w-full rounded shadow-sm sm:text-sm border @error('description') border-red-300 @else border-gray-600 @enderror bg-gray-900 text-white py-2 px-3" placeholder="Enter description">{{ old('description') ?? $event->description }}</textarea>
