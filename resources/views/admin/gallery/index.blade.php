...
@section('content')
    ...
    <div class="overflow-x-auto w-full pt-6 pb-4">
        <div class="flex">
            <p class="text-lg">All Categories</p>
            <div class="ml-auto">
                <a class="inline-block rounded-sm border border-slate-500 bg-slate-500 px-6 py-2 text-sm font-medium text-white hover:bg-transparent hover:text-slate-500 focus:ring-3 focus:outline-hidden"
        ...
        <table class="border-collapse border border-slate-500 my-2 w-full text-slate-300">
            <thead>
                <tr>
                    ...
                    <th class="border border-slate-600 bg-slate-700 p-3 text-sm">Thumb</th>
                        ...
                        <td class="border border-slate-700 p-3 ">
                            <div class="flex items-center justify-center">
                                <span
                                    ...
                                    <a href="{{ route('admin.gallery.category.edit', $item->id) }}"
                                    ...
                                    <form action="{{ route('admin.gallery.category.destroy', $item->id) }}"
