...
<span class="group relative block h-64 sm:h-72">
    ...
    <div class="w-full h-full -z-10 overflow-hidden">
        <img src="{{ asset('/img/f-bg.png') }}" alt="" class="h-full w-full">
    </div>
    ...
    <div
        ...
        <div
            ...
            <h2 class="mt-4 text-xl font-medium sm:text-2xl text-slate-700 text-center">{{ $title }}</h2>

            <p class="mt-4 text-sm sm:text-base text-slate-500 text-center">
                {{ $sub_title }}
            </p>
        </div>
        ...
        <div
            ...
            <h3 class="mt-4 text-xl font-medium sm:text-3xl text-slate-700 text-center">{{ $title }}</h3>
